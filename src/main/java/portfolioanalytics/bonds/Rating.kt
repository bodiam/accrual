...
/**
 * A term is the time horizon in which a bond will mature. Generally, bonds maturing in one year or less are
...
/**
 * A company that assesses the credit risk of bonds and their issuers
